<template>
  <div class="">
    ...
    <div
      v-if="hasTokenExpiredOrIsInvalid"
...
let hasTokenExpiredOrIsInvalid = ref(true);
...
onMounted(() => {
  try {
    ...
    hasTokenExpiredOrIsInvalid.value = isJwtExpired(providedToken.value);
...
let isResettingPassword = ref(false);
